...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 bg-blue-700 p-5 w-full flex justify-between items-center">
      ...
      <div className="flex gap-5">
        <Link className="text-white text-md hover:text-red-500 transition-colors cursor-pointer" href="/">
          Home
        </Link>
